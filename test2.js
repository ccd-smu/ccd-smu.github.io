$(document).ready(function() {
  ...
  $('body').append($('<script src="https://xwtoh.github.io/placement-mobile.js"></script>'));
  $('head').append('<link rel="stylesheet" type="text/css" href="https://xwtoh.github.io/Placement-mobile.css">');}
